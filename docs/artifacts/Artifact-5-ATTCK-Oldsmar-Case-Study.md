...
|---|---|---|
| SCADA workstation directly internet-connected | OT-zone hosts have no external internet egress by design; administrative inter-zone SSH access is permitted and documented (Artifact 3) | **Materially stronger.** The public internet entry vector doesn't exist in this architecture, though administrative SSH pathways between zones remain authorized |
